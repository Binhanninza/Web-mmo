...
// Lấy Info User
if (isset($_SESSION['user_id'])) {
    $uid_menu = (int)$_SESSION['user_id'];
    if(isset($conn)) {
        $active_stmt = $conn->prepare("UPDATE users SET last_active = NOW() WHERE id = ?");
        $active_stmt->bind_param("i", $uid_menu);
        $active_stmt->execute();
        $active_stmt->close();

        $menu_stmt = $conn->prepare("SELECT money, lv, avatar FROM users WHERE id = ?");
        $menu_stmt->bind_param("i", $uid_menu);
        $menu_stmt->execute();
        $res_menu = $menu_stmt->get_result();
          ...
          <div class="app-brand demo">
            <a href="/index.php" class="app-brand-link">
              <?php if(!empty($site_logo)): ?>
                  <span class="app-brand-logo demo"><img src="<?php echo e($site_logo); ?>" style="max-height:40px;" alt="Logo"></span>
              <?php else: ?>
                  <span class="app-brand-text demo menu-text fw-bolder ms-2 text-uppercase"><?php echo e($site_name); ?></span>
              <?php endif; ?>
            </a>
                    ...
                    <li class="nav-item navbar-dropdown dropdown-user dropdown">
                      <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                        <div class="avatar avatar-online">
                            <img src="<?php echo e(!empty($my_avt) ? $my_avt : '/assets/img/avatars/1.png'); ?>"
                                 alt="Avatar"
                            ...
                            <a class="dropdown-item" href="#">
                                <div class="d-flex">
                                    <div class="flex-shrink-0 me-3">
                                        <div class="avatar avatar-online">
                                            <img src="<?php echo e(!empty($my_avt) ? $my_avt : '/assets/img/avatars/1.png'); ?>" onerror="this.src='/assets/img/avatars/1.png'" />
                                        </div>
                                    </div>
                                    <div class="flex-grow-1">
                                        <span class="fw-semibold d-block">ID: <?php echo e($_SESSION['user_id']); ?></span>
